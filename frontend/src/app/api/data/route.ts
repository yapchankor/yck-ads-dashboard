...
function enrichRecommendation(raw: any) {
  ...
  return {
    ...
    suggestedAction,
    keyword,
    campaignName: raw.campaign_name || raw.campaign || raw.target_id || null,
    ad_group_name: raw.ad_group_name || raw.adset_name || null,
    ...
    location_id: raw.location_id || raw.country_criterion_id || null,
    negative_keywords: Array.isArray(raw.negative_keywords) ? raw.negative_keywords : [],
    match_type: raw.match_type || null,
    formula: raw.formula || null,
    assumptions: Array.isArray(raw.assumptions) ? raw.assumptions : [],
    current: raw.current || null,
    suggested: raw.suggested || null,
    issue: raw.issue || null,
    headline: raw.headline || null,
    final_url: raw.final_url || null,
    image_prompt: raw.image_prompt || null,
    campaign_ids: Array.isArray(raw.campaign_ids) ? raw.campaign_ids : [],
    current_cpa: numberOrNull(raw.current_cpa),
    suggested_adjustment: raw.suggested_adjustment || null,
    time_slot: raw.time_slot || null,
    current_spend: numberOrNull(raw.current_spend),
    current_performance: raw.current_performance || null,
    how_to_apply: raw.how_to_apply || null,
  ...
  try {
    ...
    const mappedData = {
      ...
      search_queries: (data.search_queries || []).map((q: any) => ({
        query: q.query || q.search_term,
        campaign: q.campaign || q.campaign_name,
        campaign_id: q.campaign_id || null,
        campaign_status: q.campaign_status || null,
        ad_group_id: q.ad_group_id || null,
        ad_group_name: q.ad_group_name || null,
        ad_group_status: q.ad_group_status || null,
        match_type: q.match_type || null,
        status: q.status || null,
        impressions: q.impressions || 0,
        clicks: q.clicks || 0,
        cost: q.cost || 0,
        conversions: q.conversions || 0,
        conversion_value: q.conversion_value || 0,
        avg_cpc: q.avg_cpc || 0,
        ctr: q.ctr != null ? q.ctr : q.clicks && q.impressions ? q.clicks / q.impressions : 0,
        cpa: q.cpa || (q.conversions > 0 ? q.cost / q.conversions : 0),
      })),
      geo_performance: (data.geo_performance || []).map((g: any) => ({
        location_name: g.location_name,
        location_id: g.location_id || g.criterion_id || g.country_criterion_id || null,
        criterion_resource_name: g.criterion_resource_name || null,
        criterion_status: g.criterion_status || null,
        negative: g.negative || false,
        campaign_id: g.campaign_id || null,
        campaign_name: g.campaign_name || "",
        campaign_status: g.campaign_status || null,
        impressions: g.impressions || 0,
        clicks: g.clicks || 0,
        cost: g.cost || g.spend || 0,
        conversions: g.conversions || 0,
        conversion_value: g.conversion_value || 0,
        ctr: g.ctr || 0,
        cpa: g.cpa || g.cost_per_conversion || 0,
      })),
      ad_groups: (data.ad_groups || []).map((a: any) => ({
        id: a.ad_group_id || a.id || "",
        ad_group_id: a.ad_group_id || a.id || "",
        ad_group_name: a.ad_group_name || a.name || "",
        status: a.status || "",
        ...
        ctr: a.ctr || 0,
        avg_cpc: a.avg_cpc || 0,
        spend: a.spend || a.cost || 0,
        cost: a.cost || a.spend || 0,
        conversions: a.conversions || 0,
        cpa: a.cpa || a.cost_per_conversion || 0,
      ...
      google_ads: (data.ads || []).map((a: any) => ({
        ...
        ad_group_status: a.ad_group_status || "",
        final_urls: Array.isArray(a.final_urls) ? a.final_urls : [],
        headlines: Array.isArray(a.headlines) ? a.headlines : [],
      ...
      google_time_performance: data.google_time_performance || null,
      google_geo_analysis: data.google_geo_analysis || null,
      google_device_performance: data.device_performance || null,
      google_device_rows: data.google_device_rows || [],
      budget_pacing: data.budget_pacing || null,
      landing_page_heatmap: data.landing_page_heatmap || null,
      quality_score_roadmap: data.quality_score_roadmap || null,
      search_query_analysis: data.search_query_analysis || null,
      conversion_value_alert: data.conversion_value_alert || null,
      google_negative_keywords: data.google_negative_keywords || data.negative_keywords || [],
      insights: data.insights || [],
      keywords: (data.keywords || []).map((k: any) => ({
        keyword: k.keyword,
        keyword_text: k.keyword_text || k.keyword,
        resource_name: k.resource_name || null,
        target_id: k.target_id || k.resource_name || null,
        campaign: k.campaign,
        campaign_id: k.campaign_id || null,
        campaign_name: k.campaign_name || k.campaign || null,
        campaign_status: k.campaign_status || null,
        ad_group_id: k.ad_group_id || null,
        ad_group_name: k.ad_group_name || null,
        ad_group_status: k.ad_group_status || null,
        ...
        cpa: k.cpa || k.cost_per_conversion || 0,
        conversion_value: k.conversion_value || 0,
        quality_score: k.quality_score || null,
        ad_relevance: k.ad_relevance || null,
        landing_page_experience: k.landing_page_experience || null,
        expected_ctr: k.expected_ctr || null,
      })),
